...
const WalkingMapModal = ({ route, userLocation, onClose }) => {
  ...
  return (
    <div ref={wrapRef} style={{position:'fixed',inset:0,zIndex:9999,background:'#050810',display:'flex',flexDirection:'column'}}>
      ...
      <div ref={mapElRef} style={{flex:1,width:'100%',position:'relative',minHeight:0}}>
        ...
        {loading && (
          <div style={{position:'absolute',inset:0,zIndex:10,display:'flex',flexDirection:'column',
            ...
            <p style={{color:C,fontSize:13,fontWeight:700,letterSpacing:1,
              textShadow:`0 0 12px rgba(0,243,255,0.6)`}}>{loadMsg}</p>
                ...
                <div style={{display:'flex',alignItems:'center',gap:14}}>
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    <p style={{color:'#fff',fontSize:20,fontWeight:800,lineHeight:1.2,margin:0,
                      overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{curI.msg}</p>
                    {nextI&&<p style={{color:'rgba(0,243,255,0.6)',fontSize:12,margin:'4px 0 0',
        ...
        <motion.button whileTap={{scale:0.88}} onClick={nav?stopNav:onClose}
          style={{position:'absolute',top:'max(env(safe-area-inset-top,0px),14px)',left:14,
        ...
        <motion.button whileTap={{scale:0.88}} onClick={toggleFullscreen}
          style={{position:'absolute',top:'max(env(safe-area-inset-top,0px),14px)',right:14,
            zIndex:30,width:42,height:42,borderRadius:21,
            background:'rgba(5,8,16,0.8)',backdropFilter:'blur(14px)',
        ...
        {nav&&(
          <motion.button whileTap={{scale:0.9}} onClick={toggleOverview}
            style={{position:'absolute',top:'max(env(safe-area-inset-top,0px),14px)',right:66,
        ...
        {/* Badge GPS */}
        {tracking&&acc!=null&&(
          <div style={{position:'absolute',bottom:nav?16:200,left:14,zIndex:20,
            background:'rgba(5,8,16,0.8)',backdropFilter:'blur(14px)',
        ...
        <AnimatePresence>
          {arrived&&(
            <motion.div key="arrived"
              ...
              <p style={{color:C,fontSize:22,fontWeight:900,margin:0,
        ...
        {nav&&!overview&&remain!=null&&(
          <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}}
            style={{position:'absolute',bottom:16,right:14,zIndex:20,
            ...
            <p style={{color:C,fontSize:22,fontWeight:900,margin:0,lineHeight:1,
              textShadow:`0 0 12px rgba(0,243,255,0.6)`}}>{dist(remain)}</p>
      ...
      {/* ─── PAINEL INFERIOR ──────────────────────────────────────────── */}
      <div style={{background:'#0a0d16',borderTop:'1px solid rgba(0,243,255,0.1)',
        ...
        <div style={{padding:nav?'0 20px 20px':'16px 20px 24px'}}>
          ...
          <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:16,
            ...
            <MapPin style={{color:C,width:18,height:18,flexShrink:0,
              filter:'drop-shadow(0 0 6px rgba(0,243,255,0.6))'}} strokeWidth={2}/>
            <div style={{flex:1,minWidth:0}}>
              <p style={{color:'rgba(0,243,255,0.4)',fontSize:10,fontWeight:700,
            ...
            {remain!=null&&(
              <div style={{textAlign:'right',flexShrink:0}}>
                <p style={{color:C,fontSize:20,fontWeight:900,margin:0,lineHeight:1,
                  textShadow:`0 0 10px rgba(0,243,255,0.5)`}}>{dist(remain)}</p>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:10,marginBottom:16}}>
            {[
              ...
              <div key={label} style={{background:'rgba(0,243,255,0.04)',borderRadius:14,
          ...
          <div style={{marginBottom:16}}>
            <div style={{display:'flex',justifyContent:'space-between',marginBottom:6}}>
              ...
              <span style={{color:C,fontSize:10,fontWeight:800,
                textShadow:`0 0 8px rgba(0,243,255,0.5)`}}>{Math.round(pct)}%</span>
            </div>
